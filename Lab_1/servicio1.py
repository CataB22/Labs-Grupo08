...
HOST_S1 = 'localhost'
PORT_S1_SERVER = 65431  # Puerto para escuchar al servicio 4
PORT_S2_SERVER = 65432  # Puerto del servicio 2
...
def send_tcp_message(host, port, mensaje):
    ...
    try:
        ...
        time.sleep(2)
        send_tcp_message(host, port, mensaje)
    except Exception as e:
        print(f"Ocurrió un error al enviar mensaje TCP: {e}")
...
def servicio1():
    ...
    # envia el mensaje inicial al servicio 2 (cliente TCP)
    send_tcp_message(HOST_S1, PORT_S2_SERVER, mensaje)

    # inicia el servidor para "escuchar" al servicio 4
